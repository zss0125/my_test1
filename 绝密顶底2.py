...
# @timer
# def security_name_to_code(security_info_df,security_name_list):
#     df = pd.DataFrame()
...
def main():
    ...
    start_date = end_date - datetime.timedelta(days=1000)  # 本地时间减去190天为开始时间
    ...
    print_date(end_date)
    dingdi_df = juemi_dingdi(security_code_list, Period='weekly',
